...
const DROPDOWN_API_ENDPOINT = 'https://kx0wer4mua.execute-api.us-east-1.amazonaws.com/prod'; // GET/POST REST API 
const ML_API_ENDPOINT = 'https://4kerjn0l42.execute-api.us-east-1.amazonaws.com/prod'; // POST REST API
